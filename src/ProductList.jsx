...
import { addItem } from './CartSlice'; // Import addItem
...
const handleAddToCart = (plant) => {
    e.preventDefault();  // Prevent any default action (like a page refresh)
    dispatch(addItem(plant)); // Dispatch addItem when adding an item to the cart
